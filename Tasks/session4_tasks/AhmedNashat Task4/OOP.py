class Human:
    ...
    def walk(self):
        print("I am walking 🚶🏼‍➡️")
    def talk(self):
        print("I am talking 🗣️")
    ...
    def introduce_yourself (self):
            if (self.gender==""):
                  ...
                  print(f"My name is {self.name}, I am {self.age} years old, I am a {self.nationality} and my sex is {self.gender}")
...
class Man(Human):
    ...
    def can_fly(self):
            print("I can not fly ✈️❌")
    def work(self):
            print("I can work ⚒️")
    def shave_beard(self):
            print("My beard is shaved 🧔🏼‍♂️")         
...
Human.gender = input("Classify your self (MALE / WOMEN): ").lower()
